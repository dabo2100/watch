                ...
                <div className='grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-5 gap-10'>
                    <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 col-span-3 gap-5'>
                        <div className='flex flex-col '>
                            ...
                            <p className='mt-4 font-(family-name:--second-font) text-[14px] text-[#777777] italic'>17 Princess Road, London, Greater London <br /> NW1 8JR, UK</p>
                    ...
                    <div className='grid grid-cols-5 col-span-2 items-center relative '>
                        ...
                        <div onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className=" flex items-center justify-center gap-2 w-[167px] h-[52px] bg-[#F07F13] rounded-[4px] cursor-pointer rotate-270 transition-all duration-300 sm:relative sm:mx-auto sm:mt-6 lg:absolute lg:right-[30px] lg:top-1/2 lg:-translate-y-1/2">
